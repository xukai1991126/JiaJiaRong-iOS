...
@interface ApplicationRecordViewController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation ApplicationRecordViewController
...
- (void)fetchApplyRecords {
    ...
    [[NetworkService sharedInstance] POST:@"/app/userinfo/apply" 
                                   params:@{} 
...
- (void)repaymentButtonTapped:(UIButton *)sender {
    ...
    RepaymentPlanViewController *vc = [[RepaymentPlanViewController alloc] init];
    vc.loanNo = loanNo;
