...
// 顶部安全区域高度（状态栏 + 导航栏）
#define kTopSafeAreaHeight (kStatusBarHeight + kNavigationBarHeight)

// 底部安全区域高度
#define kBottomSafeAreaHeight (kIOSVersion >= 11.0 ? [UIApplication sharedApplication].keyWindow.safeAreaInsets.bottom : 0)

// TabBar高度
#define kTabBarHeight (49.0f + kBottomSafeAreaHeight)
