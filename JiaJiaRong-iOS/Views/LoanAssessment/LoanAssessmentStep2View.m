...
@interface LoanAssessmentStep2View ()
...
@implementation LoanAssessmentStep2View
...
- (void)setupUI {
    ...
    self.questionLabel.text = @"2. 您的个人信用是？";
...
- (void)createOptionButtons {
    NSArray<NSString *> *options = self.viewModel.allOptions[1]; // 直接使用第二步的选项
